...
var credits = [
	...
	["Sound Effects", "Explosion by freesound_community of pixabay.com", "Alarm by mixkit.co", "Implemented by: Alexander Rabinovich"],
	["Testers", "Luis Canales", "Ethan Graham", "Alexander Rabinovich"],
	[
		"Tools used", "Developed with Godot Engine 4.3", "https://godotengine.org/license", "",
		"Art created with Aseprite", "https://www.aseprite.org"
	],
	["Final thoughts"], ["Alexander Rabinovich", "We challenged ourselves as first-time devs", "And we will be giving ourselves a pat on the back",
		"For releasing a semi-complete product"], ["Luis Canales", "It's nerf or nothing"], ["Ethan Graham", "I hated it, but no it was interesting"],
...
func add_line():
	...
	new_line.text = str(section.pop_front())
